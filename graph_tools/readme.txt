...
INTRODUCTION
======================================================================================================================
Use the BarGraph class to create horizontal / vertical bar graphs, progress bars and faders. You can
create simple graphs and even grouped bar graphs with legends, add labels, change colors etc. No graphics
or graphical libraries required.
...
You can make a donation on my website: http://www.gerd-tentler.de/tools/pygraphs/
...
Optional:
  ...
  o graphBorder => graph border: string (CSS-spec: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o graphPadding => graph padding: integer (pixels)

  o titles => titles: array or string with comma-separated values
  o titleColor => title font color: string
  o titleBGColor => title background color: string
  o titleBorder => title border: string (CSS specification: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o titleFont => title font family: string (CSS specification, e.g. "Arial, Helvetica")
  o titleSize => title font size: integer (pixels)
  o titleAlign => title text align: "left", "center", or "right"
  o titlePadding => title padding: integer (pixels)

  o labels => label names: list or string with comma-separated values
  o labelColor => label font color: string
  o labelBGColor => label background color: string
  o labelBorder => label border: string (CSS-spec: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o labelFont => label font family: string (CSS-spec, e.g. "Arial, Helvetica")
  ...
  o barColors => bar colors OR bar images: list or string with comma-separated values
  o barBGColor => bar background color: string
  o barBorder => bar border: string (CSS-spec: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o barLevelColors => bar level colors: ascending list (bLevel, bColor[,...]); draw bars >= bLevel with bColor

  o showValues => show values: integer (0 = % only [default], 1 = abs. and %, 2 = abs. only, 3 = none)
  o baseValue => base value: integer or float (only hBar and vBar)

  o absValuesColor => abs. values font color: string
  o absValuesBGColor => abs. values background color: string
  o absValuesBorder => abs. values border: string (CSS-spec: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o absValuesFont => abs. values font family: string (CSS-spec, e.g. "Arial, Helvetica")
  ...
  o percValuesFont => perc. values font family: string (CSS-spec, e.g. "Arial, Helvetica")
  ...
  hBar/vBar only:
  o legend => legend items: list or string with comma-separated values
  o legendColor => legend font color: string
  o legendBGColor => legend background color: string
  o legendBorder => legend border: string (CSS-spec: "size style color", e.g. "1px solid black"; doesn't work with NN4)
  o legendFont => legend font family: string (CSS-spec, e.g. "Arial, Helvetica")
  o legendSize => legend font size: integer (pixels)
  o legendAlign => legend vertical align: "top", "center", "bottom"
  o legendAbsValues => view abs. values in legend: 1 = yes, 0 = no
...
======================================================================================================================
Source code + examples available at http://www.gerd-tentler.de/tools/pygraphs/.
======================================================================================================================
